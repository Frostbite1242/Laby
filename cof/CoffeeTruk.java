...
public class CoffeeTruk {
    private final double Capacity;
    private double freeSpace;
    private final ArrayList<Coffee> coffeeCargo;


    public CoffeeTruk(double Capacity) {
    ...
    public void sortByPricePerWeight() {
        coffeeCargo.sort(new byPricePerWeight());
    }

    public String toString() {
        StringBuilder output = new StringBuilder("CoffeeWagon{" +
                "freeSpace=" + freeSpace +
                ", coffeeCargo:\n");
        for (Coffee coffee : coffeeCargo) {
            output.append(coffee.toString()).append("\n");
        }
